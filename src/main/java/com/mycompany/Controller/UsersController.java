...
public class UsersController {
    ...
    public String editUser(){
        ...
        System.out.println("--------------------1--------------------------------");
        System.out.println(this.user.getId()!=null?this.user.getId():this.user.getUserName());
        System.out.println("--------------------1--------------------------------");
        System.out.println("--------------------1--------------------------------");
        ...
        {
            context.addMessage(null, new FacesMessage("Format Email Salah"));
            return null;
        }
        ...
        {
            context.addMessage(null, new FacesMessage("Gagal Update User... \n "+e));
            return null;
        }
